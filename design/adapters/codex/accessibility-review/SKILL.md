...
metadata:
  short-description: WCAG 2.1 accessibility audit
---
...
- Check recent git changes for accessibility regressions
- Scan for common patterns: missing `aria-label`, `role` attributes, keyboard event handlers without `onKeyDown`
