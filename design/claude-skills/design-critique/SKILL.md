...
When working in Claude Code, if the user references local design files or component code:
...
- Check `!git diff` for recent design-related changes that may need review
